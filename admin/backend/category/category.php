...
<html>
  ...
  <body>
        <div class="col-md-10 col-md-offset-1" style="margin-top: 10px;" >
          <div style="margin-bottom: 5px;"><a href="admin.php?quanly=add_category_product" class="btn btn-primary">Add</a>
            <a href="admin.php?quanly=add_exel_db" class="btn btn-primary">Import DB Excel</a>
             <a href="admin.php?quanly=delete_all" class="btn btn-primary">Delete All</a>
          </div>
